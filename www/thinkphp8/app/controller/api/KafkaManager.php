...
class KafkaManager extends BaseController
{
    ...
    public function getTopics(Request $request)
    {
        try {
            ...
            Log::error('获取Kafka主题失败error:{error},trace:{trace}', [
                'error' => $e->getMessage(),
    ...
    public function createTopic(Request $request)
    {
        try {
            ...
            Log::error('创建Kafka主题失败error:{error},trace:{trace}', [
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function deleteTopic(Request $request)
    {
        try {
            ...
            Log::error('删除Kafka主题失败，error:{error},trace:{trace}', [
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function getBrokers(Request $request)
    {
        try {
            ...
            Log::error('获取Kafka Broker失败error:{error},trace:{trace}', [
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString()
            ]);
